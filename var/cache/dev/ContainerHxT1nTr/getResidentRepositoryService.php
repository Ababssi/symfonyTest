 ...
 */
class getResidentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResidentRepository' shared autowired service.
     *
     * @return \App\Repository\ResidentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResidentRepository.php';

        return $container->privates['App\\Repository\\ResidentRepository'] = new \App\Repository\ResidentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
